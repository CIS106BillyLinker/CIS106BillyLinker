...
if incometax < 0:
  incometax = 100
print(f"Last name: {lastname} Number of dependents: {dependents} Gross income: ${grossincome: .2f} Adjusted gross income: ${adjustedgrossincome} IncomeTax: ${incometax: .2f}")